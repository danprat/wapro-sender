...
let DOCUMENT_ELEMENT_SELECTORS = {
  ...
  send_message_btn: [
    ...
    '#main footer .copyable-area button[aria-label]',
    '#main footer ._ak1r button',
    '#main footer [role="button"]',
    'footer .copyable-area span[role="button"]',
    'footer div[aria-label] button'
  ],
};
...
// AWS APIs / URLs
let AWS_API = {
  PLAN_FETCH: "https://aws-api.vercel.app/ps/fp",
  GET_CONFIG_DATA: "https://aws-api.vercel.app/ps/gc",
